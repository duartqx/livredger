...
func LancamentosRouter(templFS fs.FS) *RouterMap {
	return &RouterMap{
		"GET /api/lancamentos":  GetApiLancamentos,
		...
		"GET /lancamentos": View(&ViewContext{
			...
			DataFunc: GetLancamentosDataFunc,
		}),
		"GET /lancamentos/{chave}": View(&ViewContext{
			...
			DataFunc: GetLancamentosPorChaveDataFunc,
		}),
...
func GetApiLancamentos(w http.ResponseWriter, r *http.Request) {
...
func GetLancamentosDataFunc(r *http.Request) (map[string]any, error) {
...
func GetLancamentosPorChaveDataFunc(r *http.Request) (map[string]any, error) {
